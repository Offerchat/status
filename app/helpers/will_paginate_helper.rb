module WillPaginateHelper
  class WillPaginateAjaxLinkRenderer < WillPaginate::ActionView::LinkRenderer
    ...
    def link(text, target, attributes = {})
      ...
      ajax_call = "$.ajax({url: '#{target}', dataType: 'script', success: function() {$('#loading-indicator').hide();} , beforeSend: function() {$('div.post').hide();$('div.poste').hide();$('#loading-indicator').show();}});"
